...
public static class LineIntersection
{
        ...
        float x3, float y3, float x4, float y4, bool checkOnInside, out Vector2 point, float tolerance = kTolerance)
    {
        ...
        {
            //throw new LogException("Both lines overlap vertically, ambiguous intersection points.");
            point = Vector2.zero;
            return false;
        }
        ...
        {
            //throw new LogException("Both lines overlap horizontally, ambiguous intersection points.");
            point = Vector2.zero;
            return false;
        }
